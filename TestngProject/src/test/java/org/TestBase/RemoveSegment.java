...
public class RemoveSegment extends BaseClass {
	...
	WebElement segmentCode;
	String segmentCodeValue;
	...
	//	System.out.println("Value of saleable from UI is:" + saleableValue);
		...
		//	moveToReadyForSegmentation();
			...
			Thread.sleep(2000);
			segmententity.clickEntityname();
			segmententity.filterButton();
			segmententity.ruleTab();
			segmententity.filterDropdown();
			segmententity.filterSearchBox();
			segmententity.codeOption();
			segmententity.inputTextBox().sendKeys("83794");
			segmententity.applyFilterButton();
			Thread.sleep(20000);
			...
			segmentCode = partentity.segmentValue();
			segmentCodeValue = gettext(segmentCode);
		     if(!segmentCodeValue.isEmpty()) {
			 System.out.println("Segment is created");
			 writeResult.writeToExcelNewSegmentValue(4,segmentCodeValue);
	...
	public void partAttributes() throws IOException {
		
		scroll = new ScrollByVisibleElement();
		HomePage hp = new HomePage();
		textbox = new GetTextBoxValue();
		
		System.out.println("Part Table attributes:........................................");
		
		ArrayList<String> listOfAttributesPart = new ArrayList<String>();
		
		WebElement engineModel = partentity.engineModel();
		scroll.ByVisibleElement(engineModel);
		String engineModelValue = gettext(engineModel);
		System.out.println("engineModel: " + engineModelValue);
		listOfAttributesPart.add(engineModelValue);
		
		WebElement certificationLevel = partentity.certificationLevel();
		scroll.ByVisibleElement(certificationLevel);
		String certificationLevelValue = gettext(certificationLevel);
		System.out.println("certificationLevelValue: " + certificationLevelValue);
		listOfAttributesPart.add(certificationLevelValue);
		
		WebElement displacementLitre = partentity.displacementLitre();
		scroll.ByVisibleElement(displacementLitre);
		String displacementLitreValue = gettext(displacementLitre);
		System.out.println("displacementLitreValue: " + displacementLitreValue);
		listOfAttributesPart.add(displacementLitreValue);
		
		WebElement marketApplication = partentity.marketApplication();
		scroll.ByVisibleElement(marketApplication);
		String marketApplicationValue = gettext(marketApplication);
		System.out.println("marketApplicationValue: " + marketApplicationValue);
		listOfAttributesPart.add(marketApplicationValue);
		
		WebElement engineType1 = partentity.engineType1();
		scroll.ByVisibleElement(engineType1);
		String engineType1Value = gettext(engineType1);
		System.out.println("engineType1Value: " + engineType1Value);
		listOfAttributesPart.add(engineType1Value);
		
		WebElement electricVoltage = partentity.electricVoltage();
		scroll.ByVisibleElement(electricVoltage);
		String electricVoltageValue = gettext(electricVoltage);
		System.out.println("electricVoltageValue: " + electricVoltageValue);
		listOfAttributesPart.add(electricVoltageValue);
		
		WebElement electricOutput = partentity.electricOutput();
		scroll.ByVisibleElement(electricOutput);
		String electricOutputValue = gettext(electricOutput);
		System.out.println("electricOutputValue: " + electricOutputValue);
		listOfAttributesPart.add(electricOutputValue);
		
		WebElement electricTechnology = partentity.electricTechnology();
		scroll.ByVisibleElement(electricTechnology);
		String electricTechnologyValue = gettext(electricTechnology);
		System.out.println("electricTechnologyValue: " + electricTechnologyValue);
		listOfAttributesPart.add(electricTechnologyValue);
		
		WebElement electricInterface = partentity.electricInterface();
		scroll.ByVisibleElement(electricInterface);
		String electricInterfaceValue = gettext(electricInterface);
		System.out.println("electricInterfaceValue: " + electricInterfaceValue);
		listOfAttributesPart.add(electricInterfaceValue);
		
		WebElement noOfChargePorts = partentity.noOfChargePorts();
		scroll.ByVisibleElement(noOfChargePorts);
		String noOfChargePortsValue = gettext(noOfChargePorts);
		System.out.println("noOfChargePortsValue: " + noOfChargePortsValue);
		listOfAttributesPart.add(noOfChargePortsValue);
		
		WebElement pantograph = partentity.pantograph();
		scroll.ByVisibleElement(pantograph);
		String pantographValue = gettext(pantograph);
		System.out.println("pantographValue: " + pantographValue);
		listOfAttributesPart.add(pantographValue);
		
		WebElement acChargePort = partentity.acChargePort();
		scroll.ByVisibleElement(acChargePort);
		String acChargePortValue = gettext(acChargePort);
		System.out.println("acChargePortValue: " + acChargePortValue);
		listOfAttributesPart.add(acChargePortValue);
		
		WebElement energy = partentity.energy();
		scroll.ByVisibleElement(energy);
		String energyValue = gettext(energy);
		System.out.println("energyValue: " + energyValue);
		listOfAttributesPart.add(energyValue);
		
		WebElement capacity = partentity.capacity();
		scroll.ByVisibleElement(capacity);
		String capacityValue = gettext(capacity);
		System.out.println("capacityValue: " + capacityValue);
		listOfAttributesPart.add(capacityValue);
		
		WebElement electrificationProgram = partentity.electrificationProgram();
		scroll.ByVisibleElement(electrificationProgram);
		String electrificationProgramValue = gettext(electrificationProgram);
		System.out.println("capacityValue: " + electrificationProgramValue);
		listOfAttributesPart.add(electrificationProgramValue);
		
		WebElement manufacture = partentity.manufacture();
		scroll.ByVisibleElement(manufacture);
		String manufactureValue = gettext(manufacture);
		System.out.println("manufactureValue: " + manufactureValue);
		listOfAttributesPart.add(manufactureValue);
		
		String listOfAttributesPartString = "";

		for (String s : listOfAttributesPart) {
			listOfAttributesPartString += s + ", \t";
		}

		writeResult.writeToExcelListOfAttributesPart(1, listOfAttributesPartString);

		
	}
	

    public void segmentAttributes() throws IOException {
	
	scroll = new ScrollByVisibleElement();
	HomePage hp = new HomePage();
	textbox = new GetTextBoxValue();
	ArrayList<String> listOfAttributesSegment = new ArrayList<String>();
	
	    System.out.println("Segment Table attributes:........................................");
		
		WebElement engineModel = segmententity.engineModel();
		scroll.ByVisibleElement(engineModel);
		String engineModelValue = gettext(engineModel);
		System.out.println("engineModel: " + engineModelValue);
		listOfAttributesSegment.add(engineModelValue);
		
		WebElement certificationLevel = segmententity.certificationLevel();
		scroll.ByVisibleElement(certificationLevel);
		String certificationLevelValue = gettext(certificationLevel);
		System.out.println("certificationLevelValue: " + certificationLevelValue);
		listOfAttributesSegment.add(certificationLevelValue);
		
		WebElement displacementliters = segmententity.displacementLiters();
		scroll.ByVisibleElement(displacementliters);
		String displacementlitersValue = gettext(displacementliters);
		System.out.println("displacementlitersValue: " + displacementlitersValue);
		listOfAttributesSegment.add(displacementlitersValue);
		
		WebElement marketapplication = segmententity.marketapplication();
		scroll.ByVisibleElement(marketapplication);
		String marketapplicationValue = gettext(marketapplication);
		System.out.println("marketapplicationValue: " + marketapplicationValue);
		listOfAttributesSegment.add(marketapplicationValue);
		
		WebElement enginetype = segmententity.enginetype();
		scroll.ByVisibleElement(enginetype);
		String enginetypeValue = gettext(enginetype);
		System.out.println("enginetypeValue: " + enginetypeValue);
		listOfAttributesSegment.add(enginetypeValue);
		
		WebElement electricvoltage = segmententity.electricvoltage();
		scroll.ByVisibleElement(electricvoltage);
		String electricvoltageValue = gettext(electricvoltage);
		System.out.println("electricvoltageValue: " + electricvoltageValue);
		listOfAttributesSegment.add(electricvoltageValue);
		
		WebElement electricoutput = segmententity.electricoutput();
		scroll.ByVisibleElement(electricoutput);
		String electricoutputValue = gettext(electricoutput);
		System.out.println("electricoutputValue: " + electricoutputValue);
		listOfAttributesSegment.add(electricoutputValue);
		
		WebElement electrictechnology = segmententity.electrictechnology();
		scroll.ByVisibleElement(electrictechnology);
		String electrictechnologyValue = gettext(electrictechnology);
		System.out.println("electrictechnologyValue: " + electrictechnologyValue);
		listOfAttributesSegment.add(electrictechnologyValue);
		
		WebElement electricinterface = segmententity.electricinterface();
		scroll.ByVisibleElement(electricinterface);
		String electricinterfaceValue = gettext(electricinterface);
		System.out.println("electricinterfaceValue: " + electricinterfaceValue);
		listOfAttributesSegment.add(electricinterfaceValue);
		
		WebElement noOfChargedPorts = segmententity.noOfChargedPorts();
		scroll.ByVisibleElement(noOfChargedPorts);
		String noOfChargedPortsValue = gettext(noOfChargedPorts);
		System.out.println("noOfChargedPortsValue: " + noOfChargedPortsValue);
		listOfAttributesSegment.add(noOfChargedPortsValue);
		
		WebElement pantograph = segmententity.pantograph();
		scroll.ByVisibleElement(pantograph);
		String pantographValue = gettext(pantograph);
		System.out.println("pantographValue: " + pantographValue);
		listOfAttributesSegment.add(pantographValue);
		
		WebElement acChargedPorts = segmententity.acChargePorts();
		scroll.ByVisibleElement(acChargedPorts);
		String acChargedPortsValue = gettext(acChargedPorts);
		System.out.println("acChargedPortsValue: " + acChargedPortsValue);
		listOfAttributesSegment.add(acChargedPortsValue);
		
		WebElement energy = segmententity.energy();
		scroll.ByVisibleElement(energy);
		String energyValue = gettext(energy);
		System.out.println("energyValue: " + energyValue);
		listOfAttributesSegment.add(energyValue);
		
		WebElement capacity = segmententity.capacity();
		scroll.ByVisibleElement(capacity);
		String capacityValue = gettext(capacity);
		System.out.println("capacityValue: " + capacityValue);
		listOfAttributesSegment.add(capacityValue);
		
		WebElement electrificationProgram = segmententity.electrificationProgram();
		scroll.ByVisibleElement(electrificationProgram);
		String electrificationProgramValue = gettext(electrificationProgram);
		System.out.println("electrificationProgramValue: " + electrificationProgramValue);
		listOfAttributesSegment.add(electrificationProgramValue);
		
		 WebElement manufacturer = segmententity.manufacturer();
		 scroll.ByVisibleElement(manufacturer);
		 String manufacturerValue = gettext(manufacturer);
		 System.out.println("manufacturerValue: " + manufacturerValue);
		 listOfAttributesSegment.add(manufacturerValue);
		 
		 
		 String listOfAttributesSegmentString = "";

			for (String s : listOfAttributesSegment) {
				listOfAttributesSegmentString += s + ", \t";
			}

			writeResult.writeToExcelListOfAttributesSegment(1, listOfAttributesSegmentString);

...
public class ExplorerPage_010_PartEntity extends BaseClass {//rename Explorer_010_Part
	
	public ExplorerPage_010_PartEntity() {
...
private WebElement ruleFilter;
	  ...
	  @FindBy(xpath="(//mat-icon[@role='img'])[16]")
	  ...
	  @FindBy(xpath="//div[@class='q-control-size ng-star-inserted']")

...
public class modelCreation extends BaseClass{
	...
	public void modelCreation() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		model.modelDisplayName().sendKeys("DisplayNameFromExcel");	
		...
		assertEquals(message,"Model Updated Successfully.", "Model Updated successfully");
